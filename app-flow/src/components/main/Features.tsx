...
export default function Features({ handleLaunchApp }: { handleLaunchApp: () => void }) {
  ...
  return (
    <section id="features" className="py-24 bg-bg-secondary relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[url(`data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23334155' fill-opacity='0.03'%3E%3Cpath d='M20 20L0 0v40l20-20zm20 0L20 0v40l20-20z'/%3E%3C/g%3E%3C/svg%3E`)] opacity-30"></div>
      ...
      <div className="container mx-auto px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
            Everything you need to design, prototype, and ship beautiful Android UIs faster than ever before.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-bg-tertiary border border-border rounded-xl p-8 h-full hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10">
